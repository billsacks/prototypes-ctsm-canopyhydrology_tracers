! This implementation passes individual arrays explicitly for any routine that sets bulk
! water variables (including routines that set both bulk+tracers), but not for routines
! that set only tracer variables.
